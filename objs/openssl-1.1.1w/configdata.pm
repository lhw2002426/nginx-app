...
our %config = (
  ...
  CFLAGS => [ "-nostdinc -fno-builtin -ffreestanding -Wall -I/home/oslab/Desktop/rukos/ulib/ruxmusl/install/include -O3 -Wno-format" ],
  CPPDEFINES => [  ],
  CPPFLAGS => [  ],
  CPPINCLUDES => [  ],
  ...
  openssldir => "",
  options => "--prefix=/home/oslab/Desktop/rukos/apps/c/nginx/objs/openssl-1.1.1w/.openssl no-afalgeng no-asan no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-makedepend no-md2 no-msan no-rc5 no-sctp no-shared no-ssl-trace no-ssl3 no-ssl3-method no-threads no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.34.0",
  perlargv => [ "linux-aarch64", "--prefix=/home/oslab/Desktop/rukos/apps/c/nginx/objs/openssl-1.1.1w/.openssl", "no-shared", "no-threads", "CROSS_COMPILE=aarch64-linux-musl-", "CFLAGS=-nostdinc -fno-builtin -ffreestanding -Wall -I/home/oslab/Desktop/rukos/ulib/ruxmusl/install/include -O3 -Wno-format" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
  ...
  prefix => "/home/oslab/Desktop/rukos/apps/c/nginx/objs/openssl-1.1.1w/.openssl",
  processor => "",
